...
RUN apt-get update -yqq && DEBIAN_FRONTEND=noninteractive apt-get install -o APT::Immediate-Configure=0 -yqq cmake gcc-arm-none-eabi jq curl ca-certificates gnupg && apt-get clean
